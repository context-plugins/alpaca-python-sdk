...
| <code>request_options</code> | <code>[RequestOptionsOrDict](alpaca/core/request_options.py) \| None</code> | Per-call overrides for this one request, such as a timeout or extra headers. |
...
**OnSuccess**: <code>list&#91;[V2AccountActivitiesResponse](alpaca/models/unions/v2_account_activities_response.py)&#93;</code> -- returns an array of Account activities

**OnError**: <code>[ApiError](alpaca/core/exceptions.py)&#91;[RawError](alpaca/core/results.py)&#93;</code>
...
**OnSuccess**: <code>list&#91;[V2AccountActivitiesResponse1](alpaca/models/unions/v2_account_activities_response1.py)&#93;</code> -- returns an array of Account activities
...
**OnSuccess**: <code>[AccountConfigurations](alpaca/models/account_configurations.py)</code> -- Successful response
...
**OnSuccess**: <code>[Account](alpaca/models/account.py)</code> -- OK
...
**OnSuccess**: <code>list&#91;[Calendar](alpaca/models/calendar.py)&#93;</code> -- OK
...
**OnSuccess**: <code>[Clock](alpaca/models/clock.py)</code> -- OK
...
**OnSuccess**: <code>list&#91;[CanceledOrderResponse](alpaca/models/canceled_order_response.py)&#93;</code> -- Multi-Status with body.

an array of objects that include the order id and http status code for each status request.

**OnError**: <code>[ApiError](alpaca/core/exceptions.py)&#91;[DeleteAllOrdersErrorBody](alpaca/errors/delete_all_orders_error.py)&#93;</code>
...
**OnError**: <code>[ApiError](alpaca/core/exceptions.py)&#91;[DeleteOrderByOrderIdErrorBody](alpaca/errors/delete_order_by_order_id_error.py)&#93;</code>
...
**OnSuccess**: <code>list&#91;[Order](alpaca/models/order.py)&#93;</code> -- Successful response
...
**OnSuccess**: <code>[Order](alpaca/models/order.py)</code> -- Successful response
...
**OnError**: <code>[ApiError](alpaca/core/exceptions.py)&#91;[PostOrderErrorBody](alpaca/errors/post_order_error.py)&#93;</code>
...
**OnSuccess**: <code>[PortfolioHistory](alpaca/models/portfolio_history.py)</code> -- Successful response
...
**OnSuccess**: <code>list&#91;[PositionClosedReponse](alpaca/models/position_closed_reponse.py)&#93;</code> -- Multi-Status with body.

an array of PositionClosed responses

**OnError**: <code>[ApiError](alpaca/core/exceptions.py)&#91;[DeleteAllOpenPositionsErrorBody](alpaca/errors/delete_all_open_positions_error.py)&#93;</code>
...
**OnSuccess**: <code>list&#91;[Position](alpaca/models/position.py)&#93;</code> -- Successful response
...
**OnSuccess**: <code>[Position](alpaca/models/position.py)</code> -- Successful response
...
**OnSuccess**: <code>[Watchlist](alpaca/models/watchlist.py)</code> -- Successful response
...
**OnSuccess**: <code>list&#91;[Watchlist](alpaca/models/watchlist.py)&#93;</code> -- Successful response
...
**OnSuccess**: <code>[Watchlist](alpaca/models/watchlist.py)</code> -- Returns the updated watchlist
