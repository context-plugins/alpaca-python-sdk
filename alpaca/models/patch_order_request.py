...
class PatchOrderRequest(SdkBaseModel):
    """Represents a request to patch an order."""

    qty: Optional[str] = UNSET
    """number of shares to trade"""

    time_in_force: Optional[TimeInForceOrStr] = UNSET
    ...
    limit_price: Optional[str] = UNSET
    """required if original order type is limit or stop_limit"""

    stop_price: Optional[str] = UNSET
    """required if original order type is limit or stop_limit"""

    trail: Optional[str] = UNSET
...
class PatchOrderRequestDict(TypedDict):
    qty: NotRequired[str]
    time_in_force: NotRequired[TimeInForceOrStr]
